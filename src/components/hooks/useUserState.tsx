...
const useUserState = () => {
  const { users,totalPages,userData, isLoading, error, token, isLoggedIn ,loginStatus} = useAppSelector(
  ...
  return { users,totalPages,userData, isLoading, error, token: safeToken, isLoggedIn , loginStatus};
}
